...
# Opening JSON file
with open('airdrop-balances.json') as json_file:
	...
	mt.add_leaf(elements, True)
	mt.make_tree()
	print("root: ", mt.get_merkle_root())  	# Published: 0x8f4e1c18aa0323d567b9abc6cf64f9626e82ef1b41a404b3f48bfa92eecb9142